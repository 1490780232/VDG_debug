...
class Market1501(BaseImageDataset):
    ...
    def __init__(self, root, verbose=True, **kwargs):
        ...
        file = open("/media/sdb/lzy/VDG/market_attribute_all.json") #"/home/lzy/clustercontrast_test/market_attribute_all.json") #/home/lzy/Generate/re-id/00_inversion_person/encoder4editing/datasets/market_attribute_all.json")
