...
class Market1501(BaseImageDataset):
    ...
    def __init__(self, root, verbose=True, **kwargs):
        ...
        file = open("/root/cluster-contrast-reid/examples/data/market_attribute_all.json") #"/home/lzy/clustercontrast_test/market_attribute_all.json") #/home/lzy/Generate/re-id/00_inversion_person/encoder4editing/datasets/market_attribute_all.json")
    ...
    def _process_dir(self, dir_path, relabel=False):
        ...
        return dataset
    def _process_dir_train(self, data_dir, relabel=True):
